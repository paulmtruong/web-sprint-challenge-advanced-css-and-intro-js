...
function changeName(array, index, update){
  array[index]['name'] = update;
  return array;
}
...
console.log(artists[0].getArtistByIndex());
...
function addArtist(array){
    newArray = [];
    for(let i = 0; i < array.length; i++){
      array.push('id: 20', 'name: Paul Truong', 'years: 1993 - 2021', 'genre: Web Design', 'nationality: Vietnamese', 'bio: lorem ipsum',)
    }
    return array;
  }
